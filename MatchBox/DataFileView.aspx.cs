...
namespace MatchBox
{
    public partial class DataFileView : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["DataFileLookupTable"] = new Dictionary<string, int>();

            string s_guid = Guid.NewGuid().ToString();
            string s_container_id = "secForm";
            string s_frame_id = fraForm.ClientID;
            string s_frame_url = "FrameForm.aspx?i=" + DataFileModel.InterfaceName + "&q=" + s_guid;

            ((Dictionary<string, int>)Session["DataFileLookupTable"]).Add(s_guid, 0);
        ...
        protected void repTable_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ((Dictionary<string, int>)Session["DataFileLookupTable"]).Add(s_guid, n_id);
        ...
        protected void btnDownloadExcel_Click(object sender, EventArgs e)
        {
            ...
            DataFileAction.Select(ref o_data_table, ref n_pages_count, ref s_error, o_query_dictionary);
            ...
            try
            {
                ...
                o_excel.Caption = DataFileModel.InterfaceName + " [" + DateTime.Now.Year + "-" + DateTime.Now.Month + "-" + DateTime.Now.Day + "]";
        ...
        private void Bind_Search()
        {
            ...
            List<SqlParameter> o_template_parameters = new List<SqlParameter>();
            o_template_parameters.Add(new SqlParameter("@UserID", n_user_id));

            DB.Bind_List_Control(ddlTemplateSearch, "sprTemplate", ref s_error, null, o_template_parameters);
        }
        ...
        private void Bind_Table()
        {
            ...
            DataFileAction.Select(ref o_data_table, ref n_pages_count, ref s_error, Get_Query_Dictionary());
        ...
        private Dictionary<string, string> Get_Query_Dictionary()
        {
            ...
            int n_template_id = Convert.ToInt32(ddlTemplateSearch.SelectedValue);

            string s_file_name = txtFileNameSearch.Text.Trim();
            ...
            if (n_template_id > 0) { o_query_dictionary.Add("TemplateID", n_template_id.ToString()); }

            if (s_file_name != "") { o_query_dictionary.Add("FileName", s_file_name); }
        ...
        private void Delete(string s_argument = "")
        {
            ...
            DB.Delete(n_id, "sprDataFileDelete", ref s_error, n_user_id);
