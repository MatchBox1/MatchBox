...
<asp:Content ID="cntMain" ContentPlaceHolderID="cphMain" runat="server">
    <table style="width: 100%;">
        <tr class="nowrap">
            <td><h1 id="hedMain" runat="server" class="float-left">Data Inspector</h1></td>
            <td class="nowrap">&nbsp; &nbsp; - &nbsp; &nbsp;</td>
            ...
            <td class="nowrap">&nbsp; &nbsp; - &nbsp; &nbsp;</td>
            <td>
                <asp:Label ID="lblModeInfo" runat="server" Font-Bold="true" /> : <asp:Label ID="lblNote" runat="server" />
            </td>
    ...
    <section id="secSearch" runat="server" class="section-search" style="padding: 10px; font-size: 11pt;">
        ...
        <div id="divTransactions" runat="server" class="float-left div-form-field">
            ...
            <asp:DropDownList ID="ddlTransactions" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlTransactions_SelectedIndexChanged">
    ...
    <asp:Panel ID="pnlSearchResult" runat="server" Visible="false">
        ...
        <%--Payment--%>
        <asp:HiddenField ID="hidUniqueID" runat="server" OnValueChanged="hidUniqueID_ValueChanged" />
        ...
        <div id="divMatchingAuto" runat="server" visible="false" class="section-form" style="padding: 10px;">
            ...
            <table id="tblMatchingField" runat="server" class="table-sub" style="margin: 10px 0px;">
                ...
                <tr>
                    ...
                    <td class="text-center"><asp:CheckBox ID="chkTerminalNumber" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkSupplierNumber" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkCreditBrand" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkCardBrand" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkTransactionCurrency" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkCardNumber" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkCardPrefix" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkPaymentsCount" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkDutyPaymentNumber" runat="server" Checked="true" Enabled="false" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkTransmissionNumber" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkTransactionGrossAmount" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkDutyPaymentAmount" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkTransactionDate" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkPaymentDate" runat="server" Checked="true" Enabled="false" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkVoucherNumber" runat="server" Checked="true" /></td>
                    <td class="text-center"><asp:CheckBox ID="chkConfirmationNumber" runat="server" Checked="true" /></td>
                </tr>
                <tr>
                    ...
                    <td class="text-center"></td>
                    <td class="text-center"></td>
                    <td class="text-center"><asp:TextBox ID="txtToleranceTransactionGrossAmount" runat="server" Width="40px" MaxLength="5" /></td>
                    <td class="text-center"><asp:TextBox ID="txtToleranceDutyPaymentAmount" runat="server" Width="40px" MaxLength="5" /></td>
                    <td class="text-center"><asp:TextBox ID="txtToleranceTransactionDate" runat="server" Width="40px" MaxLength="3" /></td>
                    <td class="text-center"><asp:TextBox ID="txtTolerancePaymentDate" runat="server" Width="40px" MaxLength="3" /></td>
                    <td class="text-center"><asp:TextBox ID="txtToleranceVoucherNumber" runat="server" Width="40px" MaxLength="1" /></td>
                    <td class="text-center"><asp:TextBox ID="txtToleranceConfirmationNumber" runat="server" Width="40px" MaxLength="1" /></td>
                </tr>
            </table>
        ...
        <div id="divInside" runat="server" class="float-left" style="width: 49%;">
            ...
            <div class="div-form-message" style="margin: 5px 0px;">
                <table class="nowrap" style="width: 100%; font-size: 11pt;">
                    ...
                    <tr id="trInsideSelected" runat="server" visible="false" style="height: 25px;">
                        ...
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:Label ID="lblInsideRowsSelected" runat="server" /></td>
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:Label ID="lblInsideAmountSelected" runat="server" /></td>
                        <td>&nbsp; &nbsp;</td>
                        <td>&nbsp; &nbsp;</td>
                    </tr>
                    <tr id="trInsideRemaining" runat="server" visible="false" style="height: 25px;">
                        ...
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:Label ID="lblInsideRowsRemaining" runat="server" /></td>
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:Label ID="lblInsideAmountRemaining" runat="server" /></td>
                        <td>&nbsp; &nbsp;</td>
                        <td>&nbsp; &nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:Label ID="lblInsideRows" runat="server" /></td>
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:Label ID="lblInsideAmount" runat="server" /></td>
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:DropDownList ID="ddlInsidePage" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Page_Changed" Width="100px" /></td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div id="divOutside" runat="server" class="float-left" style="width: 49%;">
            ...
            <div class="div-form-message" style="margin: 5px 0px;">
                <table class="nowrap" style="width: 100%; font-size: 11pt;">
                    ...
                    <tr id="trOutsideSelected" runat="server" visible="false" style="height: 25px;">
                        <td class="bold">Selected</td>
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:Label ID="lblOutsideRowsSelected" runat="server" /></td>
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:Label ID="lblOutsideAmountSelected" runat="server" /></td>
                        <td>&nbsp; &nbsp;</td>
                        <td>&nbsp; &nbsp;</td>
                    </tr>
                    <tr id="trOutsideRemaining" runat="server" visible="false" style="height: 25px;">
                        <td class="bold">Remaining</td>
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:Label ID="lblOutsideRowsRemaining" runat="server" /></td>
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:Label ID="lblOutsideAmountRemaining" runat="server" /></td>
                        <td>&nbsp; &nbsp;</td>
                        <td>&nbsp; &nbsp;</td>
                    </tr>
                    <tr>
                        <td class="bold">Total</td>
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:Label ID="lblOutsideRows" runat="server" /></td>
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:Label ID="lblOutsideAmount" runat="server" /></td>
                        <td>&nbsp; &nbsp;</td>
                        <td><asp:DropDownList ID="ddlOutsidePage" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Page_Changed" Width="100px" /></td>
                    </tr>
                </table>
            </div>
        </div>
