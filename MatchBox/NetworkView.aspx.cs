...
namespace MatchBox
{
    public partial class NetworkView : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["NetworkLookupTable"] = new Dictionary<string, int>();

            string s_guid = Guid.NewGuid().ToString();
            string s_container_id = "secForm";
            string s_frame_id = fraForm.ClientID;
            string s_frame_url = "FrameForm.aspx?i=" + NetworkModel.InterfaceName + "&q=" + s_guid;

            ((Dictionary<string, int>)Session["NetworkLookupTable"]).Add(s_guid, 0);
        ...
        protected void repTable_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ((Dictionary<string, int>)Session["NetworkLookupTable"]).Add(s_guid, n_id);
        ...
        protected void btnDownloadExcel_Click(object sender, EventArgs e)
        {
            ...
            NetworkAction.Select(ref o_data_table, ref n_pages_count, ref s_error, o_query_dictionary);
            ...
            try
            {
                ...
                o_excel.Caption = NetworkModel.InterfaceName + " [" + DateTime.Now.Year + "-" + DateTime.Now.Month + "-" + DateTime.Now.Day + "]";
        ...
        private void Bind_Table()
        {
            ...
            NetworkAction.Select(ref o_data_table, ref n_pages_count, ref s_error, Get_Query_Dictionary());
        ...
        private Dictionary<string, string> Get_Query_Dictionary()
        {
            ...
            string s_network_name = txtNetworkNameSearch.Text.Trim();
            ...
            if (s_network_name != "") { o_query_dictionary.Add("NetworkName", s_network_name); }
        ...
        private void Delete(string s_argument = "")
        {
            ...
            DB.Delete(n_id, "sprNetworkDelete", ref s_error, n_user_id);
