    ...
    public partial class TemplateView : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["result"] != null && Request.QueryString.Get("result") == "inserted")
            {
                ...
                chkImportable.Checked = false;
                chkImportable.Visible = false;
                lnkRefresh.Visible = true;
            }

            Session["TemplateIsImportable"] = chkImportable.Checked;
            Session["TemplateLookupTable"] = new Dictionary<string, int>();

            string s_guid = Guid.NewGuid().ToString();
            string s_container_id = "secForm";
            string s_frame_id = fraForm.ClientID;
            string s_frame_url = "FrameForm.aspx?i=" + TemplateModel.InterfaceName + "&q=" + s_guid;

            ((Dictionary<string, int>)Session["TemplateLookupTable"]).Add(s_guid, 0);
            ...
            divImportable.Visible = (o_user.IsAdmin == false);
        ...
        protected void Select_Importable(object sender, EventArgs e)
        {
            Bind_Table();
        }
        ...
        protected void repTable_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (chkImportable.Checked == true)
                {
                    // CAN'T DELETE IMPORTABLE TEMPLATES
                ...
                ((Dictionary<string, int>)Session["TemplateLookupTable"]).Add(s_guid, n_id);
        ...
        protected void btnDownloadExcel_Click(object sender, EventArgs e)
        {
            ...
            TemplateAction.Select(ref o_data_table, ref n_pages_count, ref s_error, o_query_dictionary);
            ...
            try
            {
                ...
                o_excel.Caption = TemplateModel.InterfaceName + " [" + DateTime.Now.Year + "-" + DateTime.Now.Month + "-" + DateTime.Now.Day + "]";
        ...
        private void Reset()
        {
            ...
            ddlCreditSearch.SelectedIndex = 0;
            ddlDiscountSearch.SelectedIndex = 0;
        }
        ...
        private void Bind_Search()
        {
            ...
            if (o_user.IsAdmin)
            {
                DB.Bind_List_Control(ddlCreditSearch, "sprCredit", ref s_error);
                DB.Bind_List_Control(ddlDiscountSearch, "sprDiscount", ref s_error);
            }
            else if (o_user.IsUser)
            {
                ...
                o_discount_parameters.Add(new SqlParameter("@UserID", n_user_id));

                DB.Bind_List_Control(ddlCreditSearch, "sprUserCredit", ref s_error, null, o_credit_parameters);
                DB.Bind_List_Control(ddlDiscountSearch, "sprUserDiscount", ref s_error, null, o_discount_parameters);
            }
        }
        ...
        private void Bind_Table()
        {
            ...
            TemplateAction.Select(ref o_data_table, ref n_pages_count, ref s_error, Get_Query_Dictionary());
        ...
        private Dictionary<string, string> Get_Query_Dictionary()
        {
            ...
            int n_credit_id = Convert.ToInt32(ddlCreditSearch.SelectedValue);
            int n_discount_id = Convert.ToInt32(ddlDiscountSearch.SelectedValue);
            ...
            if (n_credit_id > 0) { o_query_dictionary.Add("CreditID", n_credit_id.ToString()); }
            if (n_discount_id > 0) { o_query_dictionary.Add("BranchID", n_discount_id.ToString()); }
            ...
            o_query_dictionary.Add("IsImportable", chkImportable.Checked.ToString());
        ...
        {
            if (chkImportable.Checked == true) { return; }
            ...
            DB.Delete(n_id, "sprTemplateDelete", ref s_error, n_user_id);
