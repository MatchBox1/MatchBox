...
namespace MatchBox
{
    public partial class StrategyView : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["StrategyLookupTable"] = new Dictionary<string, int>();

            string s_guid = Guid.NewGuid().ToString();
            string s_container_id = "secForm";
            string s_frame_id = fraForm.ClientID;
            string s_frame_url = "FrameForm.aspx?i=" + StrategyModel.InterfaceName + "&q=" + s_guid;

            ((Dictionary<string, int>)Session["StrategyLookupTable"]).Add(s_guid, 0);
        ...
        protected void repTable_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                int n_id = 0, n_status_id = 0;

                int.TryParse(o_data_row["ID"].ToString(), out n_id);
                int.TryParse(o_data_row["StatusID"].ToString(), out n_status_id);
                ...
                ((Dictionary<string, int>)Session["StrategyLookupTable"]).Add(s_guid, n_id);
        ...
        protected void btnDownloadExcel_Click(object sender, EventArgs e)
        {
            ...
            StrategyAction.Select(ref o_data_table, ref n_pages_count, ref s_error, o_query_dictionary);
            ...
            try
            {
                ...
                o_excel.Caption = StrategyModel.InterfaceName + " [" + DateTime.Now.Year + "-" + DateTime.Now.Month + "-" + DateTime.Now.Day + "]";
        ...
        private void Bind_Table()
        {
            ...
            StrategyAction.Select(ref o_data_table, ref n_pages_count, ref s_error, Get_Query_Dictionary());
        ...
        private Dictionary<string, string> Get_Query_Dictionary()
        {
            ...
            string s_strategy_name = txtStrategyNameSearch.Text.Trim();
            ...
            if (s_strategy_name != "") { o_query_dictionary.Add("StrategyName", s_strategy_name); }
        ...
        private void Delete(string s_argument = "")
        {
            ...
            DB.Delete(n_id, "sprStrategyDelete", ref s_error, n_user_id);
