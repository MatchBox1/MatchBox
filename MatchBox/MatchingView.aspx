<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MatchingView.aspx.cs" Inherits="MatchBox.MatchingView" %>
...
<asp:Content ID="cntMain" ContentPlaceHolderID="cphMain" runat="server">
    <table style="width: 100%;">
        <tr class="nowrap">
            ...
            <td>&nbsp;|&nbsp;</td>
            <td><a href="MatchingNew.aspx">Add new</a></td>
            <td>&nbsp;|&nbsp;</td>
