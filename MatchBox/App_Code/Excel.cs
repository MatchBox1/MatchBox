...
namespace MatchBox
{
    public class ExcelAction
    {
        ...
        public static void Bind_Data_Table_New(string s_excel_file_path, ref DataTable o_data_table, ref string s_error, string s_excel_sql = "", string s_hdr = "YES", int n_rows = 0)
        {
            //DataTable dtResult = null;
            int totalSheet = 0; //No of sheets on excel file  
            using (OleDbConnection objConn = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + s_excel_file_path + ";Extended Properties='Excel 12.0;HDR=NO;IMEX=1;';"))
            {
                try
                {
                    objConn.Open();
                    ...
                    o_data_table = ds.Tables["excelData"];
                    //objConn.Close();
